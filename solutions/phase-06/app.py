...
- ALWAYS use the search_docs_by_lang_chain tool for ANY LangChain-related question
- Never answer LangChain questions from memory
- Use the documentation tool first, then answer based on the retrieved docs
